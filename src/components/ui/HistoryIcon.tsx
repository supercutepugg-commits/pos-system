...
export default function HistoryIcon({ size = 18, className = '' }: { size?: number; className?: string }) {
  return (
    <svg viewBox="0 0 60 76" width={size} height={size * (76 / 60)} className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M22 34c1.5 3 4.8 5 8 5s6.5-2 8-5" stroke="#1A1A1A" strokeWidth="2.2" strokeLinecap="round" fill="none" />
      <path d="M30 34v3" stroke="#1A1A1A" strokeWidth="1.6" strokeLinecap="round" />
      <rect x="14" y="50" width="32" height="24" rx="14" fill="#F5A93C" stroke="#1A1A1A" strokeWidth="2.2" />
