        ...
        {grouped.map((msg) => (
          <div key={msg.id}>
            ...
            <div className={`flex items-end gap-2 ${isMe(msg) ? "flex-row-reverse" : "flex-row"}`}>
              ...
              <div
                className={`flex flex-col max-w-[70%] ${isMe(msg) ? "items-end" : "items-start"}`}
              >
                {}
                {!isMe(msg) && msg.showProfile && (
                  <div className="flex items-center gap-1.5 mb-1 ml-1">
                    ...
                    <span
                      className={`text-xs font-medium ${ROLE_COLOR[msg.user?.role ?? "sales"]}`}
                    >
                ...
                <div
                  className={`flex items-end gap-1.5 ${isMe(msg) ? "flex-row-reverse" : "flex-row"}`}
                >
                  {}
                  <div
                    className={`px-3.5 py-2.5 rounded-2xl shadow-sm text-sm leading-relaxed break-words ${
                      isMe(msg)
