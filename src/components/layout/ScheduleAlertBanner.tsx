            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-semibold text-slate-900 truncate" title={a.name}>
                    {a.name}
                  </p>
                  <p className="text-xs text-slate-500">
                    {a.label} · {a.date.slice(5).replace("-", "/")}
                  </p>
                </div>
                <button
                  onClick={(e) => {
